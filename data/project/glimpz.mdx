...
- Frontend: I took the lead in designing the UI/UX of the app, ensuring an intuitive and visually appealing experience for the users. The frontend code is primarily written in React.
- Backend: I also contributed to the backend development, which is hosted on AWS. This robust infrastructure ensures that the app runs smoothly and can handle a large number of users.
...
<div className="flex flex-wrap justify-around">
  <img
    src="/static/images/project/glimpz/glimpz-1.png"
    className="m-2 w-4/5 sm:w-1/3 "
  />
  <img
    src="/static/images/project/glimpz/glimpz-2.png"
    className="m-2 w-4/5 sm:w-1/3 "
  />
  <img
    src="/static/images/project/glimpz/glimpz-3.png"
    className="m-2 w-4/5 sm:w-1/3 "
  />
  <img
    src="/static/images/project/glimpz/glimpz-4.png"
    className="m-2 w-4/5 sm:w-1/3 "
  />
  <img
    src="/static/images/project/glimpz/glimpz-5.png"
    className="m-2 w-4/5 sm:w-1/3 "
  />
  <img
    src="/static/images/project/glimpz/glimpz-6.png"
    className="m-2 w-4/5 sm:w-1/3"
  />
  <img
    src="/static/images/project/glimpz/glimpz-9.png"
    className="m-2 w-4/5 sm:w-1/3 "
  />
  <img
    src="/static/images/project/glimpz/glimpz-10.png"
    className="m-2 w-4/5 sm:w-1/3 "
  />
  <img
    src="/static/images/project/glimpz/glimpz-7.png"
    className="m-2 w-4/5 sm:w-1/3 "
  />
  <img
    src="/static/images/project/glimpz/glimpz-8.png"
    className="m-2 w-4/5 sm:w-1/3 "
  />
